...
//Feedback
if(score<=0 && horcrux===7 ){
  textSize(25);
  text("Keep trying!",380,600);
}

if(score===1 && horcrux===7 ){
  textSize(25);
  text("Good try!",400,600);
}
...
if(score===4 && horcrux===7 ){
  textSize(25);
  text("Amazing!",400,600);
}

if(score===5 && horcrux===7 ){
  textSize(25);
  text("Excellent!",400,600);
}

if(score===6 && horcrux===7 ){
  textSize(25);
  text("Outstanding!",400,600);
}

if(score===7 && horcrux===7 ){
  textSize(25);
  text("Champion! You did it!",350,600);
}
...
// To reduce harry's score when harry touches the enemies
